      ...
      <div className="h-screen overflow-y-auto relative z-10">
        <div className="flex flex-col items-center justify-center min-h-screen p-4 md:p-8">
          ...
          <div className="mb-8 text-center max-w-2xl px-4">
            <h1 className="mb-3 text-5xl font-extrabold tracking-tight text-[#8A8D8F] md:text-7xl font-display">
              EmoSense
            </h1>
            <p className="text-base font-light text-[#636668] md:text-lg max-w-xl mx-auto leading-relaxed">
        ...
        <footer className="w-full py-6 text-center text-zinc-500 bg-black/40 border-t border-white/5 backdrop-blur-md">
